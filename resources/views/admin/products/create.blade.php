    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="venom-card p-8 rounded-2xl space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" step="1000" name="price_idr" value="{{ old('price_idr', 1500000) }}" required class="w-full px-4 py-3 rounded-xl bg-[#0a0f0d] border border-[#1f2e24] text-white text-sm">
            </div>

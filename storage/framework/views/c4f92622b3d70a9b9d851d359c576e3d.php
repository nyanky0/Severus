...
<div class="min-h-screen pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6">
    <div class="flex items-center justify-between venom-card p-6 rounded-2xl">
        ...
        <a href="<?php echo e(route('admin.products.create')); ?>" class="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#00e676] to-[#10b981] text-black font-extrabold text-xs uppercase tracking-wider shadow-[0_0_20px_rgba(0,230,118,0.4)]">
            + Add New Product
        </a>
    </div>
                ...
                <tbody class="divide-y divide-[#1f2e24]">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-[#121a15]/50 transition-colors">
                            <td class="p-4">
                                <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->name); ?>" class="w-12 h-12 object-cover rounded-lg border border-[#1f2e24]">
                            </td>
                            <td class="p-4">
                                <div class="font-bold text-white text-sm"><?php echo e($product->name_en); ?></div>
                                <div class="text-[10px] text-slate-400"><?php echo e($product->name_id); ?></div>
                            </td>
                            <td class="p-4">
                            ...
                            <td class="p-4 text-white font-bold text-sm">
                                Rp <?php echo e(number_format($product->price_idr, 0, ',', '.')); ?>

                            </td>
                            <td class="p-4">
                                <a href="<?php echo e($product->tokopedia_url); ?>" target="_blank" class="text-[#42b549] hover:underline flex items-center">
                            ...
                            <td class="p-4 text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="px-3 py-1.5 rounded bg-[#121a15] hover:bg-[#1f2e24] border border-[#1f2e24] text-slate-200 font-bold">
                                        Edit
                                    </a>
                                    <form action="<?php echo e(route('admin.products.destroy', $product->id)); ?>" method="POST" onsubmit="return confirm('Delete product?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/products/index.blade.php ENDPATH**/ ?>
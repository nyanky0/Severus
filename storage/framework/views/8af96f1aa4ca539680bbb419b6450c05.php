...
<body class="bg-[#0A0F0D] text-slate-100 antialiased selection:bg-[#00E676] selection:text-black min-h-screen flex flex-col justify-between overflow-x-hidden">
    ...
    <!-- App Clean Footer -->
    <footer class="bg-[#070b09] border-t border-[#141d17] py-10 px-4 sm:px-6 lg:px-8 mt-24">
        <div class="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="flex items-center space-x-3">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Severus Logo" class="h-8 w-auto">
                <span class="font-black text-lg text-white tracking-widest uppercase">SEVERUS <span class="text-[#00E676]">CUES</span></span>
            </div>

            <div class="text-xs text-slate-500 font-medium text-center sm:text-right">
